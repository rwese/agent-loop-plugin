...
export declare function readLoopState(directory: string, customPath?: string): IterationLoopState | null;
export declare function writeLoopState(directory: string, state: IterationLoopState, customPath?: string): boolean;
export declare function clearLoopState(directory: string, customPath?: string): boolean;
export declare function incrementIteration(directory: string, customPath?: string): IterationLoopState | null;
...
export declare function sendIgnoredMessage(client: {
    session: {
        prompt(opts: {
            path: {
                id: string;
...
}, sessionID: string, text: string, logger?: Logger, options?: SendIgnoredMessageOptions): Promise<void>;
export declare function getOutputFilePath(directory: string, customPath?: string): string;
export declare function writeOutput(directory: string, message: string, data?: Record<string, unknown>, customPath?: string): boolean;
export declare function clearOutput(directory: string, customPath?: string): boolean;
export declare function createFileLogger(directory: string, customPath?: string, logLevel?: LogLevel): Logger;
